        ...
        >
          ...
          >
            <CarouselContent className="-ml-2 md:-ml-4">
              {testimonials.map((t, index) => (
                <CarouselItem key={index} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/2">
                  <div className="h-full p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md flex flex-col justify-between hover:bg-white/10 transition-colors duration-300 group">
                    <div>
            ...
            <div className="flex justify-center gap-4 mt-8">
              <CarouselPrevious className="static transform-none bg-white/5 border-white/20 hover:bg-primary hover:text-black hover:border-primary text-white" />
              <CarouselNext className="static transform-none bg-white/5 border-white/20 hover:bg-primary hover:text-black hover:border-primary text-white" />
            </div>
          </Carousel>
        </motion.div>
      </div>
