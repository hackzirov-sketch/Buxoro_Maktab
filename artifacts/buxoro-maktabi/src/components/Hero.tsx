  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex-1 flex flex-col justify-center pb-8">
        ...
        {/* Logo with glow — centered on mobile, right column on desktop */}
        <motion.div
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.1] tracking-tight font-poppins mb-5">
              Farzandingiz uchun{" "}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {stats.map((stat, i) => (
              <motion.a
                ...
                className="flex flex-col items-center justify-center gap-3 p-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl hover:bg-white/10 hover:border-primary/40 hover:shadow-[0_0_20px_rgba(74,222,128,0.12)] transition-all duration-300 group cursor-pointer"
