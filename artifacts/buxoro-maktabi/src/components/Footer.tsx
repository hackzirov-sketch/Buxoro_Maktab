...
export default function Footer() {
  ...
  return (
    <footer className="bg-black/40 border-t border-white/5 pt-14 md:pt-20 pb-8 relative overflow-hidden">
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-12 md:mb-16">
          ...
          >
            <a href="#" className="flex items-center gap-3 group">
              ...
              <span className="font-poppins font-bold text-xl text-white group-hover:text-primary transition-colors duration-300">
                Buxoro Maktabi
              </span>
            </a>
          ...
          <motion.div custom={2} variants={colVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-sm">
                ...
                <a href="tel:+998948356666" className="text-white/55 hover:text-primary transition-colors">+998 94 835 66 66</a>
              </li>
              <li className="flex items-center gap-3 text-sm">
                <Mail className="w-4 h-4 text-primary shrink-0" />
                <a href="mailto:buxoromaktabi777@gmail.com" className="text-white/55 hover:text-primary transition-colors truncate">buxoromaktabi777@gmail.com</a>
              </li>
              <li className="flex items-center gap-3 text-sm">
                <FaTelegram className="w-4 h-4 text-sky-400 shrink-0" />
                <a href="https://t.me/BM_Bekobod" target="_blank" rel="noopener noreferrer" className="text-white/55 hover:text-primary transition-colors">@BM_Bekobod</a>
              </li>
              <li className="flex items-center gap-3 text-sm">
                <FaInstagram className="w-4 h-4 text-pink-400 shrink-0" />
                <a href="https://www.instagram.com/buxoro_maktabi_bekobod/" target="_blank" rel="noopener noreferrer" className="text-white/55 hover:text-primary transition-colors">@buxoro_maktabi_bekobod</a>
              </li>
            </ul>
          </motion.div>
        ...
        <motion.div
          ...
          className="pt-6 md:pt-8 border-t border-white/8 flex flex-col sm:flex-row items-center justify-between gap-3 md:gap-4"
        >
          <p className="text-white/35 text-xs md:text-sm text-center sm:text-left">
